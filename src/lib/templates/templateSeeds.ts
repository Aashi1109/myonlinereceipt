...
import { getDefaultTemplateConfigByFamily, DEFAULT_LABELS, DEFAULT_SECTION_ORDER } from "./templateDefaults";

const makeBaseConfig = (id: string, name: string, slug: string, category: any, layoutFamily: any, isDefault = false): InvoiceTemplate => {
