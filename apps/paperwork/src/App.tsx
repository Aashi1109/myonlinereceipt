      ...
      >
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-2 px-4 sm:gap-x-4 sm:px-6 md:h-16 md:flex-nowrap lg:px-8">
          <div className="flex h-16 shrink-0 items-center">
            <BrandLockup href="/" name="Paperwork" />
          </div>
      ...
      <footer className="mt-auto border-t border-border bg-card py-12 print:hidden">
        ...
        <div className="mx-auto mt-10 max-w-7xl space-y-4 border-t border-border px-4 pt-8 text-center text-xs text-muted-foreground sm:px-6 lg:px-8">
          ...
          <nav aria-label="Paperwork information" className="flex flex-wrap justify-center gap-x-6 gap-y-3 font-semibold">
            <a className="rounded-sm underline-offset-4 hover:text-foreground hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring" href="/about">
              About
            </a>
            <a className="rounded-sm underline-offset-4 hover:text-foreground hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring" href="/privacy">
              Privacy
            </a>
            <a className="rounded-sm underline-offset-4 hover:text-foreground hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring" href="/terms">
              Terms
            </a>
            <a className="rounded-sm underline-offset-4 hover:text-foreground hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring" href="/contact">
              Contact
            </a>
          </nav>
        </div>
