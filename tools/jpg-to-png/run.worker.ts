/**
 * Moved from the `jpg-to-png` arm of `processImages` in
 * `app/media/_workers/image.worker.ts:111-207`.
 *
 * Two branches that used to be shared now live here because they were always
 * this tool's own: the input allowlist (`allowedKinds`, image.worker.ts:604)
